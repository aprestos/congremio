      ...
      >
        ...
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li>
              <div class="text-xs/6 font-semibold text-gray-400">Your conventions</div>
              <ul role="list" class="-mx-2 mt-2 space-y-1">
                <li v-for="team in teams" :key="team.name">
                  <a
                    :href="team.href"
      ...
      >
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          <form class="grid flex-1 grid-cols-1" action="#" method="GET">
            ...
            />
            <MagnifyingGlassIcon
              class="pointer-events-none col-start-1 row-start-1 size-5 self-center text-gray-400 hidden"
              aria-hidden="true"
            />
          </form>
...
const navigation = [
  ...
  { name: 'Library', href: '#', icon: UsersIcon, current: false },
  { name: 'Flee Market', href: '#', icon: FolderIcon, current: false },
  { name: 'Tournaments', href: '#', icon: CalendarIcon, current: false },
  { name: 'Prototypes', href: '#', icon: DocumentDuplicateIcon, current: false },
]
const teams = [{ id: 1, name: 'LeiriaCON', href: '#', initial: 'L', current: false }]
